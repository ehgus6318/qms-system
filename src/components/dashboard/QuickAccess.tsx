...
// 빠른 작업 바로가기 — compact 스타일 (우측 열 높이 균형용)
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col flex-shrink-0">
      ...
      <div className="flex items-center justify-between px-3.5 py-2.5 border-b border-gray-100">
        <h3 className="text-xs font-bold text-gray-800">빠른 작업</h3>
        <button className="text-[10px] text-gray-400 hover:text-gray-600 transition-colors">편집</button>
      </div>
        ...
        <div className="grid grid-cols-3 gap-1.5">
          {quickButtons.map((btn) => (
            <a
              ...
              href={btn.href}
              className={[
                'relative flex flex-col items-center justify-center gap-1 py-2.5 px-1 rounded-xl border',
            ...
            >
              {btn.badge !== undefined && (
                <span className="absolute -top-1.5 -right-1.5 w-4 h-4 bg-red-500 text-white text-[8px] font-extrabold rounded-full flex items-center justify-center shadow-sm">
                  {btn.badge}
                </span>
              )}
              {btn.icon}
      ...
      <div className="px-2.5 pb-2.5 mt-auto">
        <a
          href="/documents/new"
          className="w-full py-1.5 bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white text-[11px] font-bold rounded-xl transition-all duration-150 flex items-center justify-center gap-1.5 shadow-sm shadow-blue-200"
        >
